    ...
    if(lcd1602.menuIndexOfCurrentScreen==0){
      switch(lcd1602.firstLineNumOfCurrentScreen){
        ...
        //SETSYSTEMTIME->进入时间选择页面
          ...
          setTimeBuffer.second=getTimeBuffer.second;
          setTimeBuffer.dow=getTimeBuffer.dow; 
          lcd1602.m.ChangeALineInMenus(2,1,String("SETYEAR:20"+String(setTimeBuffer.year)));
          lcd1602.m.ChangeALineInMenus(2,2,String("SETMONTH:"+String(setTimeBuffer.month)));
          lcd1602.m.ChangeALineInMenus(2,3,String("SETDATE:"+String(setTimeBuffer.day)));
          lcd1602.m.ChangeALineInMenus(2,4,String("SETHOUR:"+String(setTimeBuffer.hour)));
          lcd1602.m.ChangeALineInMenus(2,5,String("SETMINUTE:"+String(setTimeBuffer.minute)));
          lcd1602.m.ChangeALineInMenus(2,6,String("SETSECOND:"+String(setTimeBuffer.second)));
          lcd1602.m.ChangeALineInMenus(2,7,String("SETWEEKDAY:"+String(setTimeBuffer.dow)));
      ...
      switch(lcd1602.firstLineNumOfCurrentScreen){
        ...
        //SETWATERWEIGHT
          ...
          lcd1602.m.ChangeALineInMenus(1,0,String("SETWATERW:"+String(waterWeight)+"g"));
          lcd1602.showMenuContentOnLcd(1, 0); 
        ...
        //SETCYCLEGAPDAY
          ...
          lcd1602.m.ChangeALineInMenus(1,1,String("SETWATERW:"+String(cycleGapDay)+"DS"));
